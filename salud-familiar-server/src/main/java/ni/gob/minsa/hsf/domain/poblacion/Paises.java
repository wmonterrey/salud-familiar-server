 ...
 */
@Entity
@Table(name = "PAISES", catalog = "HSF", uniqueConstraints = {
...
public class Paises implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8394895585605630210L;
	private long paisId;
	...
	@Id
	@Column(name = "PAIS_ID", unique = true, nullable = false, precision = 10, scale = 0)
