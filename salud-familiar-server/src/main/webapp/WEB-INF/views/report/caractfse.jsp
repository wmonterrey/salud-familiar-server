			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/fse" htmlEscape="true "/>"><spring:message code="step4" /></a>
					</li>
				</ul>
		...
		<div class="row">
										...
										<div id="variable-div" class="form-group">
											...
											<div class="col-md-9">
												<select data-placeholder="<spring:message code="select" /> <spring:message code="variable" />" name="variable" id="variable" class="form-control">
													<option value=""></option>
													<option value="tipoPiso"><spring:message code="piso" /></option>
													<option value="tipoTecho"><spring:message code="techo" /></option>
													<option value="tipoPared"><spring:message code="paredes" /></option>
													<option value="culturaSanitaria"><spring:message code="cult.san" /></option>
													<option value="carPsicosociales"><spring:message code="car.psic" /></option>
													<option value="satNecBasicas"><spring:message code="nec.basicas" /></option>
													<option value="tenenciaVivienda"><spring:message code="ten.viv" /></option>
													<option value="accionesComunitarias"><spring:message code="acc.com" /></option>
												</select>
											</div>
										</div>
									</div>
			...
			<div class="col-md-8">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-table"></i><spring:message code="step4" />
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<div id="grafico-div" class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart-o"></i><spring:message code="step4" />
							</div>
							<div class="actions">
...
<spring:url value="/report/caractfse" var="reportUrl"/>
<c:set var="exportar"><spring:message code="export" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.fse").removeClass("fse").addClass("active");
    });
</script>
<script>
