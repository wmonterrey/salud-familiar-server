			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/pregnancy" htmlEscape="true "/>"><spring:message code="pregnancies" /></a>
					</li>
				</ul>
						...
						<div class="portlet-body">
							...
							<thead>
								<tr>
									...
									<th><spring:message code="shortadd" /></th>
									...
									<th><spring:message code="person.cpn" /></th>
								</tr>
							</thead>
							</table>
							</div>
...
<spring:url value="/resources/scripts/view-report11.js" var="viewReport" />
...
<spring:url value="/report/pregnancies" var="reportUrl"/>
<c:set var="pregnancies"><spring:message code="pregnancies" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.reportpreg").removeClass("reportpreg").addClass("active");
    });
</script>
<script>
