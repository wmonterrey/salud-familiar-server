				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/famest/divpol" htmlEscape="true "/>"><spring:message code="families.estimated" /> <spring:message code="muni" /></a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-check-circle-o"></i><spring:message code="muni" />
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="javascript:;" class="remove"></a>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<button disabled id="lista_munis_new" onclick="agregar()" class="btn btn-success">
									<spring:message code="add" /> <i class="fa fa-plus"></i>
									</button>
								</div>
							</div>
							<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered" id="lista_munis">
							<thead>
								<tr>
...
<spring:url value="/resources/scripts/famestdivpol.js" var="famEstDiv" />
<script src="${famEstDiv}"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<c:set var="deshabilitar"><spring:message code="ROLE_DELETE" />?</c:set>
<c:set var="confirmar"><spring:message code="confirm" /></c:set>
<spring:url value="/catalog/famest/updivpol" var="opcMuniUrl"/>
<spring:url value="/catalog/famest/editDivPol" var="editUrl"/>
<spring:url value="/catalog/famest/delDivPol" var="delUrl"/>
<spring:url value="/catalog/famest/addDivPol/"	var="newDivPol"/>
...
<script>
	...
	function agregar(){
		window.location.href = "${newDivPol}"+$('#silais').val();
	};
