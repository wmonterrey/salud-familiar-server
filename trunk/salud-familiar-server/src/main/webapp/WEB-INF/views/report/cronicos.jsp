			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/cronico" htmlEscape="true "/>"><spring:message code="cronics" /></a>
					</li>
				</ul>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-table"></i><spring:message code="cronics" />
						</div>
					</div>
						...
						<table class="table table-striped table-hover table-bordered" id="consolidado">
							<thead>
								<tr>
									...
									<th><spring:message code="diabetesi" /></th>
									<th><spring:message code="diabetesii" /></th>
									<th><spring:message code="asthma" /></th>
									<th><spring:message code="ht" /></th>
									<th><spring:message code="epilepsy" /></th>
									<th><spring:message code="mental.disorder" /></th>
									<th><spring:message code="art" /></th>
									<th><spring:message code="tuberc" /></th>
								</tr>
							</thead>
						</table>
					</div>
...
<spring:url value="/resources/scripts/view-report5.js" var="viewReport" />
...
<spring:url value="/report/cronicos" var="reportUrl"/>
<c:set var="exportar"><spring:message code="export" /></c:set>
<c:set var="cronicos"><spring:message code="cronics" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.cronicos").removeClass("cronicos").addClass("active");
    });
</script>
<script>
