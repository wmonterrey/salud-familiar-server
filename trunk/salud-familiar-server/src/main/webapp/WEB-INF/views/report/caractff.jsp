			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/ff" htmlEscape="true "/>"><spring:message code="step5" /></a>
					</li>
				</ul>
		...
		<div class="row">
										...
										<div id="variable-div" class="form-group">
											...
											<div class="col-md-9">
												<select data-placeholder="<spring:message code="select" /> <spring:message code="variable" />" name="variable" id="variable" class="form-control">
													<option value=""></option>
													<option value="tamFamilia"><spring:message code="fam.size" /></option>
													<option value="ontogenesis"><spring:message code="onto" /></option>
													<option value="etapaCicloVital"><spring:message code="stage.cycle" /></option>
													<option value="crisisNormativa"><spring:message code="crisis.norm" /></option>
													<option value="crisisParanormativa"><spring:message code="crisis.para" /></option>
													<option value="usoMedTradicional"><spring:message code="med.trad" /></option>
												</select>
											</div>
										</div>
									</div>
			...
			<div class="col-md-8">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-table"></i><spring:message code="step5" />
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<div id="grafico-div" class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart-o"></i><spring:message code="step5" />
							</div>
							<div class="actions">
...
<spring:url value="/report/caractff" var="reportUrl"/>
<c:set var="exportar"><spring:message code="export" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.ff").removeClass("ff").addClass("active");
    });
</script>
<script>
