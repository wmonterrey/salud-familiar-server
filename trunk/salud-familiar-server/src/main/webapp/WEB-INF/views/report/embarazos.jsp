			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/embarazo" htmlEscape="true "/>"><spring:message code="pregnancies" /></a>
					</li>
				</ul>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-table"></i><spring:message code="pregnancies" />
						</div>
					</div>
						...
						<table class="table table-striped table-hover table-bordered" id="consolidado">
							<thead>
								<tr>
									...
									<th><spring:message code="pregnancies" /></th>
									<th><spring:message code="preg.Cpn" /></th>
									<th><spring:message code="preg.noCpn" /></th>
								</tr>
							</thead>
						</table>
					</div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="circle-stat stat-block">
						...
						<div class="details">
							<div class="title">
								 <spring:message code="preg.Cpn" />
							</div>
							<div id="knob1num" class="number">
								 0
							</div>
							<div class="title">
								 <spring:message code="pregnancies" />
							</div>
				...
				<div class="col-md-6 col-sm-6">
					<div class="circle-stat stat-block">
						...
						<div class="details">
							<div class="title">
								 <spring:message code="preg.noCpn" />
							</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<div id="consolidado-div" class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart-o"></i><spring:message code="pregnancies" />
							</div>
							<div class="actions">
...
<spring:url value="/resources/scripts/view-report4.js" var="viewReport" />
...
<spring:url value="/report/embarazos" var="reportUrl"/>
<c:set var="siCpn"><spring:message code="preg.Cpn" /></c:set>
<c:set var="allPreg"><spring:message code="pregnancies" /></c:set>
<c:set var="noCpn"><spring:message code="preg.noCpn" /></c:set>
<c:set var="exportar"><spring:message code="export" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.embarazos").removeClass("embarazos").addClass("active");
    });
</script>
<script>
	jQuery(document).ready(function() {
		...
		var parametros = {opcMuniUrl: "${opcMuniUrl}"
			...
			,language:"${pageContext.request.locale.language}",dataTablesTTSWF: "${dataTablesTTSWF}", exportar: "${exportar}"
				, siCpn: "${siCpn}", allPreg: "${allPreg}", noCpn: "${noCpn}" };
