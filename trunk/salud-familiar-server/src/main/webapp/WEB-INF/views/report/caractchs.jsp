			...
			<div class="col-md-12">
				...
				<ul class="page-breadcrumb breadcrumb">
					<li>
						...
						<i class="fa fa-angle-right"></i> <a href="<spring:url value="/report/chs" htmlEscape="true "/>"><spring:message code="step3" /></a>
					</li>
				</ul>
		...
		<div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-9">
												<select data-placeholder="<spring:message code="select" /> <spring:message code="users.nivel" />" name="area" id="area" class="form-control">
													<option value=""></option>
										...
										<div id="variable-div" class="form-group">
											...
											<div class="col-md-9">
												<select data-placeholder="<spring:message code="select" /> <spring:message code="variable" />" name="variable" id="variable" class="form-control">
													<option value=""></option>
													<option value="hacinamiento"><spring:message code="hacinamiento" /></option>
													<option value="animalesDom"><spring:message code="animdom" /></option>
													<option value="riesgoNatural"><spring:message code="risks.nat" /></option>
													<option value="riesgoMeteorologico"><spring:message code="risks.met" /></option>
													<option value="riesgoBiologico"><spring:message code="risks.bio" /></option>
													<option value="riesgoSocial"><spring:message code="risks.social" /></option>
													<option value="factoresMedAmb"><spring:message code="fact.med.amb" /></option>
													<option value="combCocinar"><spring:message code="comb.coc" /></option>
													<option value="aAgua"><spring:message code="abast.agua" /></option>
													<option value="cAgua"><spring:message code="cal.agua" /></option>
													<option value="electricidad"><spring:message code="elect" /></option>
													<option value="depExcretas"><spring:message code="dep.excretas" /></option>
													<option value="depBasura"><spring:message code="dep.basura" /></option>
													<option value="depResLiq"><spring:message code="dep.resliq" /></option>
												</select>
											</div>
										</div>
									</div>
			...
			<div class="col-md-8">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-table"></i><spring:message code="step3" />
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<div id="grafico-div" class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bar-chart-o"></i><spring:message code="step3" />
							</div>
							<div class="actions">
...
<spring:url value="/report/caractchs" var="reportUrl"/>
<c:set var="exportar"><spring:message code="export" /></c:set>
...
<script>
    $(function () {
        ...
        $("li.chs").removeClass("chs").addClass("active");
    });
</script>
<script>
