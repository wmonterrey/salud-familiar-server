...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet" id="form_entidad">
						...
						<div class="portlet-body form">
							<form action="#" class="form-horizontal" id="entidad_form">
								<div class="form-body">
									...
									<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														<input type="text" value="${famEstEntidad.famEstEntidadId}" placeholder="<spring:message code="please.enter" /> <spring:message code="families.estimated" />" class="form-control" id="famEstEntidadId" name="famEstEntidadId"/>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-6">
													<select data-placeholder="<spring:message code="select" /> <spring:message code="silais" />" name="entidad" id="entidad" class="form-control">
														<option value=""></option>
														<c:forEach items="${entidades}" var="entidad">
															<c:choose> 
																<c:when test="${entidad.codigo eq famEstEntidad.entidad.codigo}">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														<input type="text" value="${famEstEntidad.famEstimadas}" placeholder="<spring:message code="please.enter" /> <spring:message code="families.estimated" />" class="form-control" id="famEstimadas" name="famEstimadas"/>
														<span class="input-group-addon">
															<i class="fa fa-sort-alpha-asc"></i>
														</span>
													</div>
									...
									<div class="row">
										<div class="col-md-12 modal-footer">
											<spring:url value="/catalog/famest/entidad" var="famEstEntUrl"/>
											<button id="guardar" type="submit" class="btn btn-success"><spring:message code="save" /></button>
						            		<a href="${fn:escapeXml(famEstEntUrl)}" class="btn btn-danger"><spring:message code="cancel" /></a>
										</div>
									</div>
									<!-- END ROW -->
								</div>
...
<spring:url value="/resources/scripts/newestent.js" var="newEntidad" />
<script src="${newEntidad}"></script>
...
<spring:url value="/catalog/famest/saveEntidad" var="saveEntidadUrl"/>
<script>
    $(function () {
...
<script>
	jQuery(document).ready(function() {
		App.init();
		var parametros1 = { processSuccess: "${processSuccess}", saveEntidadUrl: "${saveEntidadUrl}"
			, processError: "${processError}", deniedError: "${deniedError}", famEstEntUrl: "${famEstEntUrl}"
			,language:"${pageContext.request.locale.language}" };
		NewEntidad.init(parametros1);
	});
</script>
<!-- END JAVASCRIPTS -->
</body>
