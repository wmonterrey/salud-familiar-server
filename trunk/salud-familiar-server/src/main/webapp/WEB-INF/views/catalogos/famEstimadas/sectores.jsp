				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/famest/sector" htmlEscape="true "/>"><spring:message code="families.estimated" /> <spring:message code="sector" /></a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-check-circle-o"></i><spring:message code="sector" />
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="javascript:;" class="remove"></a>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<button disabled id="lista_sectores_new" onclick="agregar()" class="btn btn-success">
									<spring:message code="add" /> <i class="fa fa-plus"></i>
									</button>
								</div>
							</div>
							<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered" id="lista_sectores">
							<thead>
								<tr>
									<th><spring:message code="sector" /></th>
...
<spring:url value="/resources/scripts/famestsector.js" var="famEstSec" />
<script src="${famEstSec}"></script>
...
<spring:url value="/catalog/famest/upsector" var="upSecUrl"/>
<spring:url value="/catalog/famest/editSector" var="editUrl"/>
<spring:url value="/catalog/famest/delSector" var="delUrl"/>
<spring:url value="/catalog/famest/addSector/"	var="addUrl"/>
...
<script>
	jQuery(document).ready(function() {
		App.init();
		var parametros = {opcMuniUrl:"${opcMuniUrl}",upSecUrl:"${upSecUrl}",
	...
	function agregar(){
		window.location.href = "${addUrl}"+$('#municipio').val();
	};
