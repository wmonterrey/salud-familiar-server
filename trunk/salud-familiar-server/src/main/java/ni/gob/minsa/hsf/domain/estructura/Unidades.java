...
public class Unidades implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7566767099439012079L;
	...
	public Unidades(long unidadId, String nombre, String razonSocial,
			...
			long codigo, char pasivo, Serializable fechaRegistro,
	...
	@Id
	@Column(name = "UNIDAD_ID", unique = true, nullable = false, precision = 10, scale = 0)
	...
	@Column(name = "TIPO_UNIDAD", nullable = false, precision = 10, scale = 0)
	...
	@Column(name = "ENTIDAD_ADTVA", nullable = false, precision = 10, scale = 0)
	...
	@Column(name = "REGIMEN", nullable = false, precision = 10, scale = 0)
	...
	@Column(name = "CATEGORIA", nullable = false, precision = 10, scale = 0)
	...
	@Column(name = "FICHA", precision = 10, scale = 0)
	...
	@Column(name = "UNIDAD_ADTVA", precision = 10, scale = 0)
