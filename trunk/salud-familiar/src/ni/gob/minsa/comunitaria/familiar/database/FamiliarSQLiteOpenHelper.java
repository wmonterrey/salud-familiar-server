...
package ni.gob.minsa.comunitaria.familiar.database;
 ...
 * </p>
 */
public abstract class FamiliarSQLiteOpenHelper {
    private static final String t = FamiliarSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public FamiliarSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
